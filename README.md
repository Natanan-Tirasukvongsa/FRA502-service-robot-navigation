...
4. ในช่วงที่ virtual box มีปัญหาต้องลงใหม่พบว่าไม่สามารถโหลด slam_gmapping ได้แม้ว่าจะโหลด sudo apt install ros-noetic-desktop-full แล้วก็ตาม แต่หลังจากนั้นสามารถแก้ปัญหานี้ได้ **__(แก้ไขแล้ว)__**
